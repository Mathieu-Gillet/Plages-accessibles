...
const CANDIDATES: Candidate[] = [
  ...
  },
  {
    ...
    description:
      "Plage de sable fin de 2 km face au golfe du Morbihan, labellisée Handiplage niveau 3. Tiralos et fauteuils Hippocampe disponibles au poste de secours, cheminement en caillebotis bois, sanitaires et douches PMR, stationnement adapté à proximité immédiate.",
    commune: 'Carnac',
    codePostal: '56340',
    departement: 'Morbihan',
    region: 'Bretagne',
  ...
  },
  {
    ...
    description:
      "Plage normande mythique avec ses planches célèbres, labellisée Handiplage niveau 3. Cheminements accessibles sur les planches, tiralos et fauteuils amphibies disponibles en saison, sanitaires PMR et douches accessibles. Service handi-accueil reconnu.",
    commune: 'Deauville',
    codePostal: '14800',
  ...
  },
  {
    ...
    description:
      "Plage de la côte de jade en Loire-Atlantique, labellisée Handiplage. Sable fin et pente douce favorisant l'accès, tiralos disponibles auprès des sauveteurs, cheminements bois depuis le front de mer, sanitaires PMR et parking aménagé à faible distance.",
    commune: 'Pornichet',
    codePostal: '44380',
  ...
  },
  {
    ...
    description:
      "Grande plage océane des Landes, labellisée Handiplage niveau 3. Cheminement en bois sur la dune, tiralos et fauteuils tout-terrain en prêt gratuit, douches et sanitaires accessibles au poste de secours principal, parking PMR à l'entrée principale.",
    commune: 'Biscarrosse',
    codePostal: '40600',
    departement: 'Landes',
    region: 'Nouvelle-Aquitaine',
  ...
  },
  {
    ...
    description:
      "Plage landaise de 8 km, classée Handiplage. Accès facilité par des passerelles en bois depuis le parking dune, tiralos disponibles en été au poste central, sanitaires et douches PMR, agent d'accueil dédié en juillet-août.",
    commune: 'Mimizan',
    codePostal: '40200',
    departement: 'Landes',
    region: 'Nouvelle-Aquitaine',
  ...
  },
  {
    ...
    description:
      "Plage catalane de 9 km en bord de Méditerranée, labellisée Handiplage niveau 3. Plusieurs accès PMR répartis sur le front de mer, tiralos et fauteuils Hippocampe disponibles à la maison de la plage, sanitaires et douches accessibles, parking PMR.",
  ...
  },
  {
    ...
    description:
      "Plage de Camargue au sable blond, labellisée Handiplage. Accès par cheminement sablé stabilisé, tiralos disponibles en saison au poste de secours, sanitaires PMR sur le front de mer. Cadre naturel exceptionnel entre étang et mer.",
  ...
  },
  {
    ...
    description:
      "Plage varoise protégée de 4 km, labellisée Handiplage niveau 3. Sable fin sur faible pente, cheminements aménagés, tiralos et fauteuils Hippocampe en prêt à la capitainerie, douches et sanitaires accessibles, plusieurs parkings PMR face à la plage.",
  ...
  },
  {
    ...
    nom: 'Plage de Bandol',
    description:
      "Plage méditerranéenne de la baie de Bandol, labellisée Handiplage niveau 3. Sable fin protégé, rampe d'accès béton, tiralos disponibles en saison, sanitaires PMR sur le front de mer, parking adapté à proximité du kiosque de plage.",
    commune: 'Bandol',
    codePostal: '83150',
    departement: 'Var',
    region: "Provence-Alpes-Côte d'Azur",
  ...
  },
  {
    ...
    description:
      "Plage du débarquement de Normandie (Juno Beach), labellisée Handiplage. Accès par rampe depuis la promenade, tiralos et fauteuils amphibies disponibles au poste de secours, douches et sanitaires PMR, parking adapté à l'entrée de la plage.",
    commune: 'Courseulles-sur-Mer',
    codePostal: '14470',
    departement: 'Calvados',
    region: 'Normandie',
    latitude: 49.3376,
